/**
 * @file nav2_client.h
 * @brief Header for Nav2Client, a class that interfaces with the Nav2 action servers for navigation and path following.
 * 
 ...
 * It handles goal responses, feedback, and results, and can optionally update a connected UI component.
 */
